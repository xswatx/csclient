...
const rows = [
  ...
  { id: 'seconds', numeric: true, disablePadding: false, label: '체류시간' },
  { id: 'num', numeric: true, disablePadding: false, label: '감지횟수' },
];
...
class AnalysisDataInfo extends React.Component {
  state = {
    order: 'asc',
    orderBy: 'time',
    selected: [],
                ...
                .map(n => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{n.seconds}</TableCell>
                      <TableCell align="right">{n.num}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
